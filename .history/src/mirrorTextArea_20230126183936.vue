<template>
    ...
    <span class="nbutton">
        <n-dropdown trigger="hover" :options="语言下拉列表项目" ref="当前语言"
            @select="处理下拉列表选择">
            <n-button >当前语言:{{当前语言}}</n-button>
        </n-dropdown>
    </span>
    <span class="nbutton">
        <n-dropdown trigger="hover" :options="主题下拉列表项目" ref="当前主题"
            @select="处理下拉列表选择">
            <n-button >主题:{{当前主题}}</n-button>
        </n-dropdown>
    </span>
    <!-- <div>
    </div> -->
...
<script lang="ts" setup>
    ...
    let 当前语言=ref(app注入数据.使用语言).value
    let 当前主题=ref(app注入数据.主题).value
    ...
    let extensions=[语言字典[当前语言], 主题字典[当前主题]]
    ...
    function 处理下拉列表选择(){
        app注入数据.mitt触发器.emit("emit监听语言切换", [当前语言, 当前主题])
        return [当前语言, 当前主题]
    }
